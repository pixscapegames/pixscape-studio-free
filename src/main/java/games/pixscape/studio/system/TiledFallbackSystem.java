        ...
        while (values.hasNext()) {
            ...
            for (int ly = 0; ly < chunk.chunkHeight; ly++) {
                for (int lx = 0; lx < chunk.chunkWidth; lx++) {
                    ...
                    // Already packed -> runtime tiled sync system owns this slot
                    if (atlasRuntimeService.resolveCached(visualAssetId, tiled.atlasTag) != null) {
                        continue;
                    }
                    ...
                    int spriteW = tex.getWidth();
                    int spriteH = tex.getHeight();
                    ...
                    state.textureHandle[slot] = TextureRegistry.handleOf(tex);
                    state.shader[slot] = 0;
